...
Cada estudiante trabaja **exclusivamente dentro de su propia carpeta**, nombrada con su código de estudiante, para que los Pull Requests de distintos estudiantes nunca choquen entre sí:
...
No edites archivos fuera de tu propia carpeta. No es necesario crear las tres subcarpetas de una vez — créalas conforme avances en el curso.

Instrucciones detalladas de qué entregar en cada actividad, cómo, y cuándo: ver [`docs/actividades/`](../docs/actividades/).
